...
data_root = '/root/autodl-tmp/pannuke_app/projects/patched_consep/training_data/'
metainfo = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root=
        '/root/autodl-tmp/pannuke_app/projects/patched_consep/training_data/',
        metainfo=dict(
            classes=('Inflammatory', 'Healthy_epithelial', 'Epithelial',
                     'Spindle-shaped'),
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/root/autodl-tmp/pannuke_app/projects/patched_consep/training_data/test/test_annotations.json',
    metric=['bbox', 'segm'],
    format_only=False,
    backend_args=None,
...
param_scheduler = [
    dict(type='LinearLR', start_factor=0.001, by_epoch=True, begin=0, end=12),
    dict(
        type='MultiStepLR',
        begin=0,
        end=12,
...
resume = False
evaluation = dict(
    interval=1, metric='segm', options=dict(maxDets=[100, 300, 1000]))
launcher = 'none'
work_dir = 'work-dir'
