...
from models.hovernet.run_desc import (proc_valid_step_output, train_step,
                                      valid_step, viz_step_output)
        ...
        "phase_list": [
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        "pretrained": "/root/autodl-tmp/pannuke_app/projects/pannuke/hovernet/train/pretrained/ImageNet-ResNet50-Preact_pytorch.tar",
                        # 'pretrained': None,
                    },
                },
