...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "/root/autodl-tmp/pannuke_app/projects/pannuke/hovernet/train/model_data/"  # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "/root/autodl-tmp/pannuke_app/projects/pannuke/hovernet/train/dataset/training_data/pannuke/pannuke/train/256x256_256x256"
        ]
        self.valid_dir_list = [
            "/root/autodl-tmp/pannuke_app/projects/pannuke/hovernet/train/dataset/training_data/pannuke/pannuke/valid/256x256_256x256"
        ]
