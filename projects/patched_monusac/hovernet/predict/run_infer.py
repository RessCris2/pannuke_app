...
if __name__ == "__main__":
    ...
    args["model_path"] = (
        ...
        "/root/autodl-tmp/pannuke_app/projects/patched_monusac/hovernet/train/net_epoch=10.tar"
    )
    # args['input_dir']=
    args[
        "type_info_path"
    ] = "/root/autodl-tmp/pannuke_app/projects/patched_monusac/hovernet/predict/type_info.json"
    args["batch_size"] = 1
    args["nr_inference_workers"] = 1
    args["nr_post_proc_workers"] = 1
    args["model_mode"] = "fast"
    args["nr_types"] = 5
    args[
        "output_dir"
    ] = "/root/autodl-tmp/pannuke_app/projects/patched_monusac/hovernet/predict/pred_data"
    args[
        "input_dir"
    ] = "/root/autodl-tmp/pannuke_app/projects/monusac/training_data/test/imgs"
    args["mem_usage"] = 0.4
    ...
    run_args.update(
        {
            ...
            "mem_usage": float(args["mem_usage"]),
            "draw_dot": False,
            "save_qupath": False,
            "save_raw_map": False,
        }
