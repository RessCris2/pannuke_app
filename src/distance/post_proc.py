...
from skimage.morphology import diamond, dilation, disk, erosion, reconstruction, square
...
if __name__ == "__main__":
    ma = cv2.imread(
        "/root/autodl-tmp/com_models/DIST/datafolder/TNBC_NucleiSegmentation/GT_01/01_1.png",
        0,
    )
