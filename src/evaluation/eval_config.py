...
model_path_dict={
        ...
        "consep": {
                "mask_rcnn": { "config_file" : '/root/autodl-tmp/archive/v2/models/mask_rcnn/file/consep/work_dir/consep_config.py',
                            "checkpoint_file" : '/root/autodl-tmp/archive/v2/models/mask_rcnn/file/consep/work_dir/epoch_12.pth'
                            },
                "mmseg_fcn":{
