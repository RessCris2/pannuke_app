        ...
        "phase_list": [
            {
                    ...
                    "net": {
                        ...
                        "optimizer": [
                            ...
                            {  # should match keyword for parameters within the optimizer
                                "lr": config.lr1,  # initial learning rate,
                                "betas": (0.9, 0.999),
                            },
                        ],
                        # learning rate scheduler
                        "lr_scheduler": lambda x: optim.lr_scheduler.StepLR(x, config.step1),
                        "extra_info": {
                            "loss": {
                                "np": {"bce": 1, "dice": 1},
                                "hv": {"mse": 1, "msge": 1},
                ...
                "batch_size": {"train": config.bs1, "valid": 8,},  # engine name : value
                "nr_epochs": config.epochs1,
            },
            {
                "run_info": {
                    # may need more dynamic for each network
                    "net": {
                        ...
                        "optimizer": [
                            optim.Adam,
                            {  # should match keyword for parameters within the optimizer
                                "lr": config.lr2,  # initial learning rate,
                                "betas": (0.9, 0.999),
                            },
                        ],
                        # learning rate scheduler
                        "lr_scheduler": lambda x: optim.lr_scheduler.StepLR(x, config.step2),
                        "extra_info": {
                            "loss": {
                                "np": {"bce": 1, "dice": 1},
                                "hv": {"mse": 1, "msge": 1},
                ...
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": config.bs2, "valid": 4,}, # batch size per gpu
                "nr_epochs": config.epochs2,
            },
        ],
        # ------------------------------------------------------------------
