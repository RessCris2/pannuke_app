...
if __name__ == "__main__":
    method_args = {
        'method': {
            ...
            # 'model_path': "/root/autodl-tmp/hover_net/logs/00/net_epoch=36.tar",
            'model_path': '/root/autodl-tmp/hover_net/logs/pannuke/01/net_epoch=50.tar'
        },
        'type_info_path': '/root/autodl-tmp/hover_net/type_info.json',
    ...
    run_args = {
        ...
        'draw_dot':True,
        "save_raw_map":True,
        # "input_dir":"/root/autodl-tmp/hover_net/dataset/raw/consep/Test/Images" ,
        "input_dir":"/root/autodl-tmp/hover_net/dataset/training_data/pannuke/test",
        "output_dir": "/root/autodl-tmp/hover_net/dataset/training_data/pannuke/test_pred",
        # "output_dir": "/root/autodl-tmp/hover_net/dataset/raw/consep/Test/pred2/",
