...
val_evaluator = dict(
    type="CocoMetric",
    ann_file="/root/autodl-tmp/pannuke_app/train/datasets/CoNSeP/Test/annotations.json",
    metric=["bbox", "segm"],
    format_only=False,
    backend_args=None,
)
...
optim_wrapper = dict(type="OptimWrapper", optimizer=dict(type="Adam", lr=0.001))
...
resume = False
launcher = "none"
work_dir = "/root/autodl-tmp/pannuke_app/train/mask_rcnn/consep/model_data"
